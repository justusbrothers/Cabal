// /plugins/Cabal/cabal/static/cabal/js/cabal/_config.js
...
const PUBLISHER_REGISTRY = [
    ...
    { name: 'Ignition Press', code: 'IGN', prefixes: ['81019'], catId: 22, catLabel: 'Indie (IND)', locId: 82, locLabel: 'Indie / Studio Boxes (82)' },
    ...
    { name: 'Invader Comics', code: 'INV', prefixes: ['78503'], catId: 22, catLabel: 'Indie (IND)', locId: 82, locLabel: 'Indie / Studio Boxes (82)' },
    ...
    { name: 'Mad Cave Comics', code: 'MAD', prefixes: ['60194', '60196', '60396'], catId: 108, catLabel: 'Mad Cave Comics (MAD)', locId: 98, locLabel: 'Mad Cave Bin (98)' },
    ...
    { name: 'Titan Comics', code: 'TIT', prefixes: ['65946', '79361'], catId: 22, catLabel: 'Titan Comics (TIT)', locId: 82, locLabel: 'Indie / Studio Boxes (82)' },
...
// -----------------------------------------------------------------
// 3. GLOBAL NAMESPACE EXPORT (Parent & Iframe Bridge)
// -----------------------------------------------------------------
window.CabalConfig = {
    isPenguinFile,
    upcColIndex,
...
// Expose safely to parent window if running inside an iframe
try {
    if (window.parent && window.parent !== window) {
        window.parent.CabalConfig = window.CabalConfig;
    }
} catch (e) {
    console.warn("[Cabal Config] Cross-origin restrictions prevented parent window sync:", e);
}
